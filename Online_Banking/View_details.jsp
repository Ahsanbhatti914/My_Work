...
<body>
    ...
    <form onsubmit="return validation()" action="ViewDetail" method="post">
	
        <h1 class="heading">VIEW YOUR ACCOUNT DETAILS</h1>
        ...
        <br>
        <input type="Submit" value="View Details" id="submit">
