	...
	try
		{
     		...
     		if(session != null)
			{
				...
				if(email.equals(sess_email) && password.equals(sess_password))
				{
					...
					Details d = obj.viewDetails(email,password);
					...
					out.println("<tr><td>"+d.getEmail()+"</td><td>"+d.getBalance()+"</td><td>"+d.getTransaction()+"</td><td>"+d.getTransBalance()+"</td><td>"+d.getTransDate()+"</td><td>"+d.getAccDate()+"</td></table>");
					out.println("</body></html>");
				}
				else
				{
